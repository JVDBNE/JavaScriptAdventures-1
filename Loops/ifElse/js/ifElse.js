...
}   else if (isNaN(num1) | isNaN(num2)) {                                                                    //introducing the pipe operator in JS... AMAZE!
    alert("At least one of the values you have entered is not a number. Reload and try again")
}   else {
